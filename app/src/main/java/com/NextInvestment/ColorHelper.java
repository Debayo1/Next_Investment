...
public class ColorHelper {
	...
	public static int returnPrimaryColor = 0xFF2962FF;
	...
	public static String getStringPrimaryColor(Context cxt) {
		return String.format("#%06X", (0xFFFFFF & returnPrimaryColor));
	}
	public static String getStringBackgroundColor(Context cxt) {
		return String.format("#%06X", (0xFFFFFF & getBackgroundColor(cxt)));
	}
	public static String getStringSecondBackgroundColor(Context cxt) {
		return String.format("#%06X", (0xFFFFFF & getSecondBackgroundColor(cxt)));
	}
	public static String getStringThirdBackgroundColor(Context cxt) {
		return String.format("#%06X", (0xFFFFFF & getThirdBackgroundColor(cxt)));
	}
	public static String getStringInverseColor(Context cxt) {
		return String.format("#%06X", (0xFFFFFF & getInverseColor(cxt)));
	}
}
